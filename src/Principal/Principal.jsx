...
import img from '../assets/Image/p-img.webp'
    ...
    return (
        <div>
             <div className='bg-slate-200'>
                <h2 className='text-5xl font-bold pt-5 pb-5'>Message from Principal</h2>
            </div>
            <div>
                <img className='img-fluid  w-80  h-80 mx-auto mt-20 mb-5 image-zoom rounded-xl' src={img} alt="" />
                <p className='text-2xl font-bold'>Md:Rakubil Islam</p>
